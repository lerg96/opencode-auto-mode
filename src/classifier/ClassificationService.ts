...
import { ClassificationResult, FilteredTranscript } from '../types/ClassificationResult';
...
export class ClassificationService {
  ...
  constructor(
    ...
    this.config = config;
    this.sessionHistory = [];
    this.injectionProtectionService = injectionProtectionService || new InjectionProtectionService();
  }
  ...
  scanToolResult(toolResult: string, sessionId?: string): Promise<{ injectionDetected: boolean }> {
    return this.injectionProtectionService.scanToolResult(toolResult, sessionId);
  }

  updateSessionHistory(messages: Array<{ role: string; content: string }>): void {
