...
const EXPLICIT_ALLOW_AGENT_PERMISSIONS: Record<string, string[]> = {
  'general': ['Read', 'Write', 'Grep', 'Glob', 'List', 'Edit', 'TodoWrite', 'Bash'],
  'explore': ['Read', 'Write', 'Grep', 'Glob', 'List', 'Edit', 'TodoWrite'],
  'research': ['Read', 'Write', 'Grep', 'Glob', 'List', 'Edit', 'TodoWrite', 'Bash'],
};

const GLOBAL_ALLOW_PERMISSIONS: string[] = [
  'Read',
  'Glob',
  'List',
  'Grep',
...
const GLOBAL_DENY_PERMISSIONS: string[] = [
  'Bash',
];
...
export class PermissionPreChecker {
  ...
  constructor(
    ...
    this.globalAllowPermissions = globalAllowPermissions || GLOBAL_ALLOW_PERMISSIONS;
    this.globalDenyPermissions = globalDenyPermissions || GLOBAL_DENY_PERMISSIONS;
    this.excludedAgents = [];
  }
